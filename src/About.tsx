            ...
            <DialogControlsSection style={{ height: "calc(100%)" }}>
                <SidebarNavigation key="1" pages={[
                            ...
                            <>
                                ...
                                <PanelSection>
                                    <DialogButton
                                        ...
                                        onClick={() => SteamClient.Installs.OpenInstallWizard([getRuntimeId("Proton EasyAntiCheat Runtime")])}
                                    >
                                ...
                                <PanelSection>
                                    <DialogButton
                                        ...
                                        onClick={() => SteamClient.Installs.OpenInstallWizard([getRuntimeId("Proton BattlEye Runtime")])}
                                    >
                                ...
                                <PanelSection>
                                    <DialogButton
                                        ...
                                        onClick={() => showModal(
                                            <ConfirmModal
                                                strTitle="Confirm"
                                                strDescription={"Uninstall dependencies?"}
                                                onOK={() => {
                                                    try {
                                    ...
                                    <PanelSection>
                                        <DialogButton
                                            onClick={() => {
                                                ...
                                                showModal(
                                                    <ConfirmModal
                                                        strTitle="Do you feel luck?"
                                                        strDescription="I told you not to click this button!"
                                                        strOKButtonText="Yes"
                                                        onOK={() => {
                    ...
                    },
                    {
                        ...
                        content: (
                            <>
                                <PanelSection>
                                    <div>
                                        Junk Store is a flexible and extensible frontend. You can use a custom backend to provide the content for the store.
                                        ...
                                        <br />
                                        <br />
                                        <DialogButton onClick={() => Navigation.NavigateToExternalWeb("https://github.com/ebenbruyns/junkstore/wiki/Custom-Backends")}>
                                            Learn More
                                        </DialogButton>
                                    </div>
                                    <br />
                        ...
                        content: (
                            <Focusable style={{ display: "flex", flexDirection: "column" }}>
                                {socialLinks.map((linkInfo, index) =>
                                    ...
                                    >
                                        <Focusable
                                            style={{ marginLeft: "auto", boxShadow: "none", display: "flex", justifyContent: "right", padding: "4px" }}
                                            //@ts-ignore
                                        ...
                                        >
                                            ...
                                            <DialogButton
                                                onClick={() => showQrModal(linkInfo.link)}
                                                style={{
                                                    display: "flex",
                    ...
                    },
                    {
                        ...
                        content: <Achievements serverAPI={serverAPI} />
                    },
                    {
                        title: "Developer",
                        visible: isDeveloperMode,
                        content: <Developer serverAPI={serverAPI} />
                    }
                ]}
                />
