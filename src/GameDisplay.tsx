import {
    PanelSection, PanelSectionRow, Focusable, ButtonItem
    ...
    return (
        <PanelSection title={props.name}>
            <Focusable style={{
                ...
                width: "100%", height: "600px", overflow: "scroll"
            }}>
                <Focusable style={{ display: 'flex' }}>
                    <ScrollPanelGroup>
                        {Array.isArray(props.images) && props.images.map((image: string) => (
                ...
                <PanelSectionRow style={{ margin: "10px" }}>
                    <ScrollPanelGroup focusable={false} style={{ flex: 1, minHeight: 0, height: "200px" }} scrollPaddingTop={32} >
